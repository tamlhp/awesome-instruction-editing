...
| -------|------|-------|----------|------|
| [Guiding Instruction-based Image Editing via Multimodal Large Language Models](https://openreview.net/forum?id=S1RKWSyZ2Y) | 2024 | ICLR | LLM-guided, Diffusion, Concise instruction loss, Supervised fine-tuning | [Code](https://mllm-ie.github.io/) | 
| [Hive: Harnessing human feedback for instructional visual editing](https://arxiv.org/abs/2303.09618) | 2024 | CVPR | RLHF, Diffusion, Data augmentation | [Code](https://shugerdou.github.io/hive/) | 
| [InstructBrush: Learning Attention-based Instruction Optimization for Image Editing](https://arxiv.org/abs/2403.18660) | 2024 | arXiv | Diffusion, Attention-based | [Code](https://royzhao926.github.io/InstructBrush/) | 
...
| [InstructGIE: Towards Generalizable Image Editing](https://arxiv.org/abs/2403.05018) | 2024 | arXiv | Diffusion, context matching |   | 
...
| [Iterative Multi-Granular Image Editing Using Diffusion Models](https://openaccess.thecvf.com/content/WACV2024/html/Joseph_Iterative_Multi-Granular_Image_Editing_Using_Diffusion_Models_WACV_2024_paper.html) | 2024 | WACV | Diffusion, Iterative editing |   | 
...
| [NeRF-Insert: 3D Local Editing with Multimodal Control Signals](https://arxiv.org/abs/2404.19204) | 2024 | arXiv | 3D Editing |   | 
...
| [AudioScenic: Audio-Driven Video Scene Editing](https://arxiv.org/abs/2404.16581) | 2024 | arXiv | audio-based instruction |   | 
...
| [SonicDiffusion: Audio-Driven Image Generation and Editing with Pretrained Diffusion Models](https://arxiv.org/abs/2405.00878) | 2024 | arXiv | Audio-driven | [Code](https://cyberiada.github.io/SonicDiffusion/) | 
| [Exploring Text-Guided Single Image Editing for Remote Sensing Images](https://arxiv.org/abs/2405.05769) | 2024 | arXiv | Remote sensing images |   | 
| [GaussianVTON: 3D Human Virtual Try-ON via Multi-Stage Gaussian Splatting Editing with Image Prompting](https://arxiv.org/abs/2405.07472) | 2024 | arXiv | Fashion editing | [Code](https://haroldchen19.github.io/gsvton/) | 
| [TIE: Revolutionizing Text-based Image Editing for Complex-Prompt Following and High-Fidelity Editing](https://arxiv.org/abs/2405.16803) | 2024 | arXiv | Chain of thought |   | 
...
| [Instruct-MusicGen: Unlocking Text-to-Music Editing for Music Language Models via Instruction Tuning](https://arxiv.org/abs/2405.18386) | 2024 | arXiv | Music editing, diffusion | [Code](https://github.com/ldzhangyx/instruct-musicgen) | 
| [Text Guided Image Editing with Automatic Concept Locating and Forgetting](https://arxiv.org/abs/2405.19708) | 2024 | arXiv | Diffusion, concept forgetting |   | 
...
| [InstructME: An Instruction Guided Music Edit And Remix Framework with Latent Diffusion Models](https://arxiv.org/abs/2308.14360) | 2023 | arXiv | Music editing, diffusion | [Code](https://musicedit.github.io/) | 
| [EditShield: Protecting Unauthorized Image Editing by Instruction-guided Diffusion Models](https://arxiv.org/abs/2311.12066) | 2023 | arXiv | authorized editing, diffusion |   | 
...
| [Learning to Follow Object-Centric Image Editing Instructions Faithfully](https://aclanthology.org/2023.findings-emnlp.646/) | 2023 | EMNLP | Diffusion, additional supervision | [Code](https://github.com/tuhinjubcse/FaithfulEdits_EMNLP2023) | 
| [StableVideo: Text-driven Consistency-aware Diffusion Video Editing](https://openaccess.thecvf.com/content/ICCV2023/html/Chai_StableVideo_Text-driven_Consistency-aware_Diffusion_Video_Editing_ICCV_2023_paper.html) | 2023 | ICCV | Diffusion, Video | [Code](https://github.com/rese1f/StableVideo) | 
| [Vox-E: Text-Guided Voxel Editing of 3D Objects](https://openaccess.thecvf.com/content/ICCV2023/html/Sella_Vox-E_Text-Guided_Voxel_Editing_of_3D_Objects_ICCV_2023_paper.html) | 2023 | ICCV | Diffusion, 3D | [Code](https://tau-vailab.github.io/Vox-E/) | 
| [FICE: Text-Conditioned Fashion Image Editing With Guided GAN Inversion](https://arxiv.org/abs/2301.02110) | 2023 | arXiv | GAN, fashion images | [Code](https://github.com/MartinPernus/FICE) | 
| [NULL-Text Inversion for Editing Real Images Using Guided Diffusion Models](https://openaccess.thecvf.com/content/CVPR2023/papers/Mokady_NULL-Text_Inversion_for_Editing_Real_Images_Using_Guided_Diffusion_Models_CVPR_2023_paper.pdf) | 2023 | CVPR | null-tex embedding, Diffusion, CLIP | [Code](https://null-text-inversion.github.io/) | 
...
| [Dialogpaint: A dialog-based image editing model](https://arxiv.org/abs/2303.10073) | 2023 | arXiv | Dialog-based |   | 
| [Inst-Inpaint: Instructing to Remove Objects with Diffusion Models](https://arxiv.org/abs/2304.03246) | 2023 | arXiv | Scene Editing | [Code](https://instinpaint.abyildirim.com/) | 
| [ImageBrush: Learning Visual In-Context Instructions for Exemplar-Based Image Manipulation](https://proceedings.neurips.cc/paper_files/paper/2023/hash/98530736e5d94e62b689dfc1fda89bd1-Abstract-Conference.html) | 2023 | NeurIPS | Example-based instruction |   | 
...
| [iEdit: Localised Text-guided Image Editing with Weak Supervision](https://arxiv.org/abs/2305.05947) | 2023 | arXiv | Localized diffusion |   | 
...
| [Target-Free Text-Guided Image Manipulation](https://ojs.aaai.org/index.php/AAAI/article/view/25134) | 2023 | AAAI | 3D Editing | [Code](https://sites.google.com/view/wancyuanfan/projects/cmanigan) | 
...
| [Unitune: Text-driven image editing by fine tuning a diffusion model on a single image](https://dl.acm.org/doi/abs/10.1145/3592451?casa_token=bP4wcwQMYtAAAAAA:pOEZ75vYUTT0vBV3ksAOSgXbHdbD8JFv4PQp56yVpuZ9brVDo8lB2Qozfy16Du9qVGfcG_u6j06B) | 2023 | TOG | Diffusion, fine-tuning |   | 
| [Dreamix: Video Diffusion Models are General Video Editors](https://arxiv.org/abs/2302.01329) | 2023 | arXiv | Cascaded diffusion, video | [Code](https://dreamix-video-editing.github.io/) | 
...
| [SSCR: Iterative Language-Based Image Editing via Self-Supervised Counterfactual Reasoning](https://aclanthology.org/2020.emnlp-main.357/) | 2020 | EMNLP | GAN, Cross-task consistency |   | 
...
| [Sequential Attention GAN for Interactive Image Editing](https://dl.acm.org/doi/abs/10.1145/3394171.3413551?casa_token=YGOhjBT6lScAAAAA:woqnI_qLRNd-NRF9mMtp3M8U6w1xG-FOAO5hqc0grrVocbSJbmXgJubblMCnOkf5hi-p6OtyJFfk) | 2020 | MM | GAN, Dialog, Sequential Attention |   | 
...
| [Text-Adaptive Generative Adversarial Networks: Manipulating Images with Natural Language](https://proceedings.neurips.cc/paper/2018/hash/d645920e395fedad7bbbed0eca3fe2e0-Abstract.html) | 2018 | NeurIPS | GAN, simple |   | 
